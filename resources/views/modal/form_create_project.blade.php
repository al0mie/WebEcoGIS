            ...
            <form class="form-horizontal" role="form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4 text-left" for="email"><p class="text-left">Название
                                проекта:</p></label>
                        <div class="col-sm-8">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div id="geoCoord">
                                        ...
                                        <br>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3 text-left" for="Bmin"><p
                                                        class="text-left">Bmin:</p></label>
                                            <div class="col-sm-3 geo-coord">
                                                <input type="text" class="form-control" id="Bmin">
                                            </div>
                                            <div class="col-sm-3 geo-coord">
                                                <input type="text" class="form-control" id="Bmin">
                                            </div>
                                            <div class="col-sm-3 geo-coord">
                                                <input type="number" class="form-control" id="Bmin">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 geo-coord">
                                                <input type="text" class="form-control" id="LminMinutes">
                                            </div>
                                            <div class="col-sm-3 geo-coord">
                                                <input type="number" class="form-control" id="LminSeconds">
                                            </div>
                                        </div>
                                    </div>
                                </div>
